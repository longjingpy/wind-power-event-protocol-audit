...
\subsubsection{Table S45. All fixed detectors on the received real-window reference}\label{table-s45.-all-fixed-detectors-on-the-received-real-window-reference}
...
\subsubsection{Table S46. Human-reference calendar-block sensitivity}\label{table-s46.-human-reference-calendar-block-sensitivity}
...
\bottomrule\noalign{}
\endlastfoot
Jiangsu & Medium-short forecast & 15-min curve; 96-point assessment; next-day \textgreater=90\%, day-10 \textgreater=70\% & Official Su监能市场〔2022〕53号 \\
