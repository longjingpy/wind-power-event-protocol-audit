...
### Table S45. Event-presence performance of all fixed detectors on the three-observer reference

Presence scoring uses 320 selected windows and the same observer-specific labels as the reference packet. Point estimates are shown; block intervals are in Table S46. The prespecified 120-min threshold is retained as the primary detector.

| Observer | Detector | Precision | Recall | F1 |
| --- | --- | ---: | ---: | ---: | --- |
| Observer 1 | Adaptive corridor | 0.825 | 0.680 | 0.746 |
| Observer 1 | Endpoint corridor 0.025 | 0.914 | 0.546 | 0.684 |
| Observer 1 | Endpoint corridor 0.050 | 0.858 | 0.686 | 0.762 |
| Observer 1 | Endpoint corridor 0.100 | 0.858 | 0.809 | 0.833 |
| Observer 1 | Financial tail 120 min | 0.825 | 0.268 | 0.405 |
| Observer 1 | Financial tail 240 min | 0.713 | 0.294 | 0.416 |
| Observer 1 | Financial tail 60 min | 0.825 | 0.242 | 0.375 |
| Observer 1 | Mean shift 120 min | 0.757 | 0.691 | 0.722 |
| Observer 1 | Mean shift 240 min | 0.716 | 0.727 | 0.721 |
| Observer 1 | Mean shift 60 min | 0.880 | 0.567 | 0.690 |
| Observer 1 | OpSDA 120 min | 0.867 | 0.603 | 0.711 |
| Observer 1 | OpSDA 240 min | 0.804 | 0.825 | 0.814 |
| Observer 1 | OpSDA 60 min | 0.931 | 0.278 | 0.429 |
| Observer 1 | SDA 0.025 | 0.877 | 0.552 | 0.677 |
| Observer 1 | Threshold 120 min | 0.781 | 0.866 | 0.822 |
| Observer 1 | Threshold 240 min | 0.700 | 0.938 | 0.802 |
| Observer 1 | Threshold 60 min | 0.897 | 0.675 | 0.771 |
| Observer 2 | Adaptive corridor | 0.963 | 0.577 | 0.721 |
| Observer 2 | Endpoint corridor 0.025 | 1.000 | 0.434 | 0.606 |
| Observer 2 | Endpoint corridor 0.050 | 0.968 | 0.562 | 0.711 |
| Observer 2 | Endpoint corridor 0.100 | 0.967 | 0.663 | 0.787 |
| Observer 2 | Financial tail 120 min | 0.921 | 0.217 | 0.352 |
| Observer 2 | Financial tail 240 min | 0.875 | 0.262 | 0.403 |
| Observer 2 | Financial tail 60 min | 0.965 | 0.206 | 0.340 |
| Observer 2 | Mean shift 120 min | 0.915 | 0.607 | 0.730 |
| Observer 2 | Mean shift 240 min | 0.893 | 0.659 | 0.759 |
| Observer 2 | Mean shift 60 min | 0.984 | 0.461 | 0.628 |
| Observer 2 | OpSDA 120 min | 0.978 | 0.494 | 0.657 |
| Observer 2 | OpSDA 240 min | 0.950 | 0.708 | 0.811 |
| Observer 2 | OpSDA 60 min | 1.000 | 0.217 | 0.357 |
| Observer 2 | SDA 0.025 | 0.967 | 0.442 | 0.607 |
| Observer 2 | Threshold 120 min | 0.940 | 0.757 | 0.838 |
| Observer 2 | Threshold 240 min | 0.919 | 0.895 | 0.907 |
| Observer 2 | Threshold 60 min | 1.000 | 0.547 | 0.707 |
| Observer 3 | Adaptive corridor | 0.844 | 0.689 | 0.758 |
| Observer 3 | Endpoint corridor 0.025 | 0.948 | 0.561 | 0.705 |
| Observer 3 | Endpoint corridor 0.050 | 0.871 | 0.689 | 0.769 |
| Observer 3 | Endpoint corridor 0.100 | 0.891 | 0.832 | 0.860 |
| Observer 3 | Financial tail 120 min | 0.778 | 0.250 | 0.378 |
| Observer 3 | Financial tail 240 min | 0.662 | 0.270 | 0.384 |
| Observer 3 | Financial tail 60 min | 0.877 | 0.255 | 0.395 |
| Observer 3 | Mean shift 120 min | 0.740 | 0.668 | 0.702 |
| Observer 3 | Mean shift 240 min | 0.701 | 0.704 | 0.702 |
| Observer 3 | Mean shift 60 min | 0.880 | 0.561 | 0.685 |
| Observer 3 | OpSDA 120 min | 0.859 | 0.592 | 0.701 |
| Observer 3 | OpSDA 240 min | 0.794 | 0.806 | 0.800 |
| Observer 3 | OpSDA 60 min | 0.966 | 0.286 | 0.441 |
| Observer 3 | SDA 0.025 | 0.893 | 0.556 | 0.686 |
| Observer 3 | Threshold 120 min | 0.772 | 0.847 | 0.808 |
| Observer 3 | Threshold 240 min | 0.704 | 0.934 | 0.803 |
| Observer 3 | Threshold 60 min | 0.918 | 0.684 | 0.784 |

### Table S46. Three-observer detector F1 sensitivity to calendar-block length

All 17 configurations and all three observers are retained. Each interval uses 2,000 shared calendar-block resamples within farm.
...
| Observer 1 | Financial tail 120 min | 3 | 248 | 0.318–0.480 |
| Observer 1 | Financial tail 120 min | 7 | 197 | 0.321–0.483 |
| Observer 1 | Financial tail 120 min | 14 | 140 | 0.309–0.498 |
| Observer 1 | Financial tail 240 min | 3 | 248 | 0.335–0.488 |
| Observer 1 | Financial tail 240 min | 7 | 197 | 0.338–0.488 |
| Observer 1 | Financial tail 240 min | 14 | 140 | 0.331–0.493 |
| Observer 1 | Financial tail 60 min | 3 | 248 | 0.288–0.452 |
| Observer 1 | Financial tail 60 min | 7 | 197 | 0.291–0.450 |
| Observer 1 | Financial tail 60 min | 14 | 140 | 0.283–0.455 |
| Observer 1 | Mean shift 120 min | 3 | 248 | 0.667–0.774 |
| Observer 1 | Mean shift 120 min | 7 | 197 | 0.671–0.771 |
| Observer 1 | Mean shift 120 min | 14 | 140 | 0.670–0.772 |
| Observer 1 | Mean shift 240 min | 3 | 248 | 0.672–0.770 |
| Observer 1 | Mean shift 240 min | 7 | 197 | 0.668–0.768 |
| Observer 1 | Mean shift 240 min | 14 | 140 | 0.674–0.768 |
| Observer 1 | Mean shift 60 min | 3 | 248 | 0.633–0.744 |
| Observer 1 | Mean shift 60 min | 7 | 197 | 0.631–0.742 |
| Observer 1 | Mean shift 60 min | 14 | 140 | 0.632–0.743 |
| Observer 1 | OpSDA 120 min | 3 | 248 | 0.659–0.762 |
| Observer 1 | OpSDA 120 min | 7 | 197 | 0.660–0.757 |
| Observer 1 | OpSDA 120 min | 14 | 140 | 0.665–0.754 |
| Observer 1 | OpSDA 240 min | 3 | 248 | 0.773–0.854 |
| Observer 1 | OpSDA 240 min | 7 | 197 | 0.774–0.852 |
| Observer 1 | OpSDA 240 min | 14 | 140 | 0.774–0.849 |
| Observer 1 | OpSDA 60 min | 3 | 248 | 0.356–0.496 |
| Observer 1 | OpSDA 60 min | 7 | 197 | 0.352–0.494 |
| Observer 1 | OpSDA 60 min | 14 | 140 | 0.351–0.498 |
| Observer 1 | SDA 0.025 | 3 | 248 | 0.621–0.732 |
| Observer 1 | SDA 0.025 | 7 | 197 | 0.621–0.726 |
| Observer 1 | SDA 0.025 | 14 | 140 | 0.622–0.726 |
| Observer 1 | Threshold 120 min | 3 | 248 | 0.779–0.859 |
| Observer 1 | Threshold 120 min | 7 | 197 | 0.781–0.857 |
| Observer 1 | Threshold 120 min | 14 | 140 | 0.784–0.855 |
| Observer 1 | Threshold 240 min | 3 | 248 | 0.762–0.839 |
| Observer 1 | Threshold 240 min | 7 | 197 | 0.763–0.838 |
| Observer 1 | Threshold 240 min | 14 | 140 | 0.764–0.839 |
| Observer 1 | Threshold 60 min | 3 | 248 | 0.723–0.815 |
| Observer 1 | Threshold 60 min | 7 | 197 | 0.720–0.816 |
| Observer 1 | Threshold 60 min | 14 | 140 | 0.720–0.816 |
...
| Observer 3 | Financial tail 120 min | 3 | 248 | 0.293–0.449 |
| Observer 3 | Financial tail 120 min | 7 | 197 | 0.294–0.450 |
| Observer 3 | Financial tail 120 min | 14 | 140 | 0.285–0.471 |
| Observer 3 | Financial tail 240 min | 3 | 248 | 0.307–0.451 |
| Observer 3 | Financial tail 240 min | 7 | 197 | 0.308–0.454 |
| Observer 3 | Financial tail 240 min | 14 | 140 | 0.298–0.465 |
| Observer 3 | Financial tail 60 min | 3 | 248 | 0.312–0.471 |
| Observer 3 | Financial tail 60 min | 7 | 197 | 0.313–0.464 |
| Observer 3 | Financial tail 60 min | 14 | 140 | 0.308–0.479 |
| Observer 3 | Mean shift 120 min | 3 | 248 | 0.645–0.753 |
| Observer 3 | Mean shift 120 min | 7 | 197 | 0.643–0.754 |
| Observer 3 | Mean shift 120 min | 14 | 140 | 0.646–0.755 |
| Observer 3 | Mean shift 240 min | 3 | 248 | 0.650–0.753 |
| Observer 3 | Mean shift 240 min | 7 | 197 | 0.646–0.752 |
| Observer 3 | Mean shift 240 min | 14 | 140 | 0.649–0.750 |
| Observer 3 | Mean shift 60 min | 3 | 248 | 0.629–0.739 |
| Observer 3 | Mean shift 60 min | 7 | 197 | 0.626–0.740 |
| Observer 3 | Mean shift 60 min | 14 | 140 | 0.623–0.743 |
| Observer 3 | OpSDA 120 min | 3 | 248 | 0.644–0.751 |
| Observer 3 | OpSDA 120 min | 7 | 197 | 0.646–0.751 |
| Observer 3 | OpSDA 120 min | 14 | 140 | 0.642–0.755 |
| Observer 3 | OpSDA 240 min | 3 | 248 | 0.755–0.843 |
| Observer 3 | OpSDA 240 min | 7 | 197 | 0.752–0.840 |
| Observer 3 | OpSDA 240 min | 14 | 140 | 0.753–0.843 |
| Observer 3 | OpSDA 60 min | 3 | 248 | 0.368–0.506 |
| Observer 3 | OpSDA 60 min | 7 | 197 | 0.364–0.513 |
| Observer 3 | OpSDA 60 min | 14 | 140 | 0.360–0.515 |
| Observer 3 | SDA 0.025 | 3 | 248 | 0.627–0.738 |
| Observer 3 | SDA 0.025 | 7 | 197 | 0.629–0.737 |
| Observer 3 | SDA 0.025 | 14 | 140 | 0.627–0.738 |
| Observer 3 | Threshold 120 min | 3 | 248 | 0.766–0.850 |
| Observer 3 | Threshold 120 min | 7 | 197 | 0.765–0.849 |
| Observer 3 | Threshold 120 min | 14 | 140 | 0.767–0.847 |
| Observer 3 | Threshold 240 min | 3 | 248 | 0.759–0.841 |
| Observer 3 | Threshold 240 min | 7 | 197 | 0.759–0.841 |
| Observer 3 | Threshold 240 min | 14 | 140 | 0.764–0.839 |
| Observer 3 | Threshold 60 min | 3 | 248 | 0.734–0.829 |
| Observer 3 | Threshold 60 min | 7 | 197 | 0.734–0.827 |
| Observer 3 | Threshold 60 min | 14 | 140 | 0.732–0.830 |
...
| --- | --- | --- | --- |
| Jiangsu | Medium-short forecast | 15-min curve; 96-point assessment; next-day >=90%, day-10 >=70% | Official Jiangsu No. 53 (2022) |
...
### Table S81. Conditional information with the implemented pre-window-power control

The joint analysis uses direction, absolute amplitude, duration and the pair-side mean of pre-window power. All three Pizhou representations use the same retained pair set. Mutual information is in nats; normalized mutual information and remaining entropy are dimensionless.

| Representation | Pairs | Retention | MI above permutation | Normalized MI | Remaining entropy |
| :-- | :-- | :-- | :-- | :-- | :-- |
| raw25 | 268,569/274,569 | 97.8% | 0.022 | 0.221 | 0.130 |
| gaf_pca6 | 268,569/274,569 | 97.8% | 0.436 | 0.404 | 0.862 |
| gaf_bit6 | 268,569/274,569 | 97.8% | 0.436 | 0.406 | 0.862 |

### Table S82. Seven-day calendar-block contributions and leave-one-block-out diagnostics

Each row uses the frozen validation-selected models and the same event targets. Ordinary rows give one seven-day block; leave_out rows remove that block. These rows describe temporal concentration in the evaluated period and are not additional independent weather replications.

| Reference | Block | Events | Compound | Scalar RMSE | Ordered RMSE | Gain |
| :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| T11 | 1 | 68 | 31 | 2.219 | 1.966 | 11.41% |
| T11 | 2 | 213 | 68 | 1.403 | 1.486 | -5.95% |
| T11 | 3 | 178 | 44 | 1.080 | 1.006 | 6.83% |
| T11 | 4 | 48 | 22 | 1.864 | 1.553 | 16.71% |
| T11 | leave_out_1 | 439 | 134 | 1.344 | 1.321 | 1.72% |
| T11 | leave_out_2 | 294 | 97 | 1.553 | 1.379 | 11.24% |
| T11 | leave_out_3 | 329 | 121 | 1.673 | 1.606 | 3.98% |
| T11 | leave_out_4 | 459 | 143 | 1.447 | 1.411 | 2.53% |
| T07 | 1 | 3 | 1 | 0.935 | 0.909 | 2.81% |
| T07 | 2 | 68 | 15 | 1.183 | 1.205 | -1.87% |
| T07 | 3 | 82 | 16 | 0.813 | 0.736 | 9.55% |
| T07 | 4 | 17 | 6 | 1.322 | 1.091 | 17.48% |
| T07 | leave_out_1 | 167 | 37 | 1.036 | 0.989 | 4.50% |
| T07 | leave_out_2 | 102 | 23 | 0.921 | 0.811 | 11.97% |
| T07 | leave_out_3 | 88 | 22 | 1.204 | 1.175 | 2.39% |
| T07 | leave_out_4 | 153 | 32 | 0.997 | 0.976 | 2.13% |
| SMARTEOLE | 1 | 4 | 0 | 0.490 | 0.641 | -30.73% |
| SMARTEOLE | 2 | 190 | 11 | 1.658 | 1.641 | 1.03% |
| SMARTEOLE | 3 | 172 | 25 | 1.165 | 1.144 | 1.80% |
| SMARTEOLE | 4 | 83 | 6 | 0.823 | 0.751 | 8.70% |
| SMARTEOLE | leave_out_1 | 445 | 42 | 1.350 | 1.327 | 1.77% |
