...
The revised analyses correct physical-lag sampling, deterministic matching, temporal covariates and event-outcome coding. Complete raw-data-to-paper automation remains under validation; the included aggregate reproduction command is separately tested.

Data assets are available for reuse with attribution to their original providers and this study. Project-authored code is MIT licensed. Original ERA5, NOAA, SDWPF, Greek, La Haute Borne and Hill of Towie source terms remain applicable.
