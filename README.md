...
The v19/v22 manuscript evidence is tracked in the [v0.4.5 release](https://github.com/longjingpy/wind-power-event-protocol-audit/releases/tag/v0.4.5) and in `outputs/protocol_benchmark_v19/RELEASE_MANIFEST_V19.json`. The repository release includes the current processed-data entry points, v22 result tables, editable Fig. 1 source and reproducibility metadata; provider attribution and upstream data terms remain applicable.
