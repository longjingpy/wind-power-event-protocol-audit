...
v18–v26 results are in the [v0.7.0 release](https://github.com/longjingpy/wind-power-event-protocol-audit/releases/tag/v0.7.0).
See `RELEASE_V26.md` and `docs/V26_MANUSCRIPT_INTEGRATION.md` for paths and scope.
