...
The v19/v22 manuscript evidence is tracked in the versioned release assets and in `outputs/protocol_benchmark_v19/RELEASE_MANIFEST_V19.json`. The repository release includes the current processed-data entry points, v22 result tables and reproducibility metadata; provider attribution and upstream data terms remain applicable.
